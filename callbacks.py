...
@callback(
	Output('voyages-bar-graphtest', 'figure'),
	Input('bar_x_vartest', 'value'),
	Input('bar_y_vartest', 'value'),
	Input('bar_agg_modetest','value'),
	Input('search_params', 'data')
	)
def update_bartest_graph(x_var,y_var,agg_mode,search_data):
	global md
